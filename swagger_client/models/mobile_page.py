...
class MobilePage(object):
    ...
    def __init__(self, version=None, icon=None, _configuration=None):  # noqa: E501
    ...
    @property
    def version(self):
        """Gets the version of this MobilePage.  # noqa: E501
        ...
        :return: The version of this MobilePage.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this MobilePage.

        The version stamp for the current object, used for optimistic locking. When saving, the same version as previously received needs to be passed back. If no one else has saved the object, the version will match and the object will be updated. However, if someone other has saved the object, the version will no longer match, and an error will be raised. This is used to prevent multiple users (or processes) from updating the same object and unwilingly overridding the property values, leading to data loss.   # noqa: E501

        :param version: The version of this MobilePage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def icon(self):
        """Gets the icon of this MobilePage.  # noqa: E501

        The character that represents the icon in the Cyclos font  # noqa: E501

        :return: The icon of this MobilePage.  # noqa: E501
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this MobilePage.

        The character that represents the icon in the Cyclos font  # noqa: E501

        :param icon: The icon of this MobilePage.  # noqa: E501
        :type: str
        """
